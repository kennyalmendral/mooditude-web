            ...
            <FormControl component="fieldset" error={formError} onChange={() => {setFormError(false)}}>
              ...
              <RadioGroup>
                <FormControlLabel 
                  ...
                  control={<Radio checked={assessmentStep7Answer == 0} onChange={handleChange} />} 
                ...
                <FormControlLabel value="1" control={<Radio checked={assessmentStep7Answer == 1} onChange={handleChange} />} label="Rarely" />
                <FormControlLabel value="2" control={<Radio checked={assessmentStep7Answer == 2} onChange={handleChange} />} label="Sometimes" />
                <FormControlLabel value="3" control={<Radio checked={assessmentStep7Answer == 3} onChange={handleChange} />} label="Often" />
                <FormControlLabel value="4" control={<Radio checked={assessmentStep7Answer == 4} onChange={handleChange} />} label="Most of the time" />
              </RadioGroup>
              {
                formError ? 
