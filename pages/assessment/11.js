      ...
      <div className={styles.onboarding_wrapper}>
        <div className={styles.onboarding_inner_wrapper}>
          ...
          <div className={`custom_stepper_wrap ${styles.custom_stepper_wrapper}`}>
            <Stepper activeStep={10} alternativeLabel={true} epand="true">
              {steps.map((label) => (
                <Step key={label}>
            ...
            <FormControl component="fieldset" error={formError} onChange={() => {setFormError(false)}}>
              ...
              <RadioGroup>
                <FormControlLabel 
                  ...
                  control={<Radio checked={assessmentStep11Answer == 1} onChange={(event) => setAssessmentStep11Answer(event.target.value)} />} 
                ...
                <FormControlLabel value="2" control={<Radio checked={assessmentStep11Answer == 2} onChange={(event) => setAssessmentStep11Answer(event.target.value)} />} label="Rarely" />
                <FormControlLabel value="3" control={<Radio checked={assessmentStep11Answer == 3} onChange={(event) => setAssessmentStep11Answer(event.target.value)} />} label="Sometimes" />
                <FormControlLabel value="4" control={<Radio checked={assessmentStep11Answer == 4} onChange={(event) => setAssessmentStep11Answer(event.target.value)} />} label="Often" />
                <FormControlLabel value="5" control={<Radio checked={assessmentStep11Answer == 5} onChange={(event) => setAssessmentStep11Answer(event.target.value)} />} label="Most of the time" />
              </RadioGroup>
              {
                formError ? 
